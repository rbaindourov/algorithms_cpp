...
public class TrieNodeSumOfPrefixScoresOfStrings {
    ...
    public int[] sumPrefixScores(String[] words) {
        ...
        for(int i = 0; i < words.length; i++ ){
            result[i] = tree.getCount(words[i]);
        }
    ...
    public static void main(String[] args) {
        TrieNodeSumOfPrefixScoresOfStrings obj = new TrieNodeSumOfPrefixScoresOfStrings();
        String[] words = {"time", "me", "bell", "ti", "t", "tim"};
        int[] result = obj.sumPrefixScores(words);
